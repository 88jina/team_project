...
class MyPage extends HTMLElement {
    constructor() {
        ...
        this.appendChild(this.template.content.cloneNode(true));
        // this.querySelector('#exit').addEventListener('click', this.hidePage.bind(this));
        this.hideMyPage();
    }
    hideMyPage() {
...
class JoinPage extends HTMLElement {
    constructor() {
        ...
        this.shadowRoot.querySelector('#exit').addEventListener('click', this.hideJoinPage.bind(this));
        this.shadowRoot.querySelector('#postBtn').addEventListener('click', this.joinPostRequest.bind(this));
        this.shadowRoot.querySelector('#duplicateCheck').addEventListener('click', this.duplGetRequest.bind(this));
        this.shadowRoot.querySelector('#certification').addEventListener('click', this.certGetRequest.bind(this));
    ...
    joinPostRequest() {
        const data = {
            loginId: this.shadowRoot.querySelector('#id').value,
            userPw: this.shadowRoot.querySelector('#password').value,
            userName: this.shadowRoot.querySelector('#name').value,
            userEmail: this.shadowRoot.querySelector('#email').value,
            userPhoneNum: this.shadowRoot.querySelector('#phone').value,
            userAddr: this.shadowRoot.querySelector('#address').value,
        };
...
class LoginPage extends HTMLElement {
    constructor() {
        ...
        document.querySelector('#exit').addEventListener('click', this.hideLoginPage.bind(this));
...
class PaymentPage extends HTMLElement {
    constructor() {
        ...
        this.appendChild(this.template.content.cloneNode(true));
        // this.shadowRoot.querySelector('#exit').addEventListener('click', this.hidePage.bind(this));
