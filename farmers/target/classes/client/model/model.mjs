...
<div class="carousel-inner container">
    <div class="carousel-item show">
      <img src="./img/cheese.jpg" class="d-block w-100" alt="...">
...
// const animatedAnchorModel = `
// <i class="fas fa-arrow-circle-up fa-3x c-ggrn round">
// </i>
// `
...
<main class="bgc-wgrn page">
    <div class="flex-row width-90 pd-a-15px center just-between">
        ...
        <h1 class="right pd-a-5px" id="exit">X</h1>
    </div>
    <div class="container bgc-wgrn pd-a-15px">

        <form class="width-100 flex-col" action="" method="post">
            <h3 class="width-90 pd-a-5px fcenter">아이디</h3>
            <input class="pd-a-10px mg-a-5px fcenter width-90" type="text" name="userId" id="id" placeholder="아이디를 입력하세요">
            <h3 class="width-90 pd-a-5px fcenter">비밀번호</h3>
            <input class="pd-a-10px mg-a-5px fcenter width-90" type="password" name="userPw" id="password" placeholder="비밀번호를 입력하세요">
            
            <div class="width-90 fcenter mg-a-5px flex-row just-between">
                <div>
                    <input class="pd-a-10px" type="checkbox" name="saveIdCheckbox" id="save-id">
                    <label class="pd-a-10px" for="saveIdCheckbox">아이디 저장</label>
                </div>
                <div>    
                    <input class="pd-a-10px" type="checkbox" name="autoLoginCheckbox" id="auto-login">
                    <label class="pd-a-10px" for="autoLoginCheckbox">자동 로그인</label>
                </div>
            </div>
            <button class="pd-a-5px width-90 fcenter mg-t-20px" type="submit">로그인</button>
        </form>
    </div>
    <div class="contariner pd-a-15px flex-col">
        <div class="center width-90 flex-row just-between">
            <a class=" " href="http://">아이디 찾기</a>
            <a class=" " href="http://">비밀번호 찾기</a>
        </div>
        <input class="pd-a-5px width-90 mg-t-10px fcenter" id="join" type="button" value="회원가입">
    </div>
</main>
`
...
<fieldset>
  ...
  <form action="/api/join" method="POST">
    <input type="text" name="loginId" id="id" placeholder="아이디를 입력해주세요">
    <input id="duplicateCheck" type="button" value="중복확인">
    <input type="password" name="userPw" id="password" placeholder="비밀번호를 입력해주세요">
    <input type="password" name="userPwCheck" id="password-checker" placeholder="비밀번호를 한번 더 입력해주세요">
    <input type="text" name="userName" id="name" placeholder="이름이 뭐에요">
    <input type="email" name="userEmail" id="email" placeholder="이메일 주소를 입력하세요">
    <input type="tel" name="userPhoneNum" id="phone" placeholder="핸드폰 번호를 입력하세요">
    <input id="certification" type="button" value="인증번호">
    <input type="checkbox" name="agreement" id="agreement-checkbox">
    <label for="agreement">전체 동의합니다.</label>
    <input id="postBtn" type="button" value="가입하기">
  </form>
</fieldset>
`
    ...
    <div class="flex-col bgc-wgrn mg-t-10px">
        <div class="flex-col">
            <div class="flex-row just-between">
                ...
                <div class="pd-a-5px" id="exit">X</div>
            </div>
            <div class="flex-row just-between">
...
<div class="flex-col bgc-lgrn page">
    <div class="bgc-wgrn pd-a-15px">
        ...
        <div class="pd-a-15px item-nav">
            ...
            <div id="exit" class="right pd-a-5px">X</div>
        </div>
